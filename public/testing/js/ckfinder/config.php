...
switch($_SERVER["HTTP_HOST"]){
    case "localhost":
        $serverRootIndex    = ($_SERVER['DOCUMENT_ROOT'].$_SERVER["HTTP_HOST"]);
        $ckFinderRootPath   = ($_SERVER['DOCUMENT_ROOT'].$_SERVER["HTTP_HOST"].'uploads');
        break;
}
ob_start();
...
$config['licenseName'] = 'muabanxecantho.com';
$config['licenseKey']  = '64Y4WKPKYVBVBZPBSJD4K434FDEDT';
