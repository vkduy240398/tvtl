        ...
        <form action="" method="post" enctype='multipart/form-data'>
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="data_post[title]" placeholder="Nhập tiêu đề">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-6 news-image">
                    <div class="avatarReader news-image text-center">
                        <img src="image/images.png" id="readerImage"  height="150" width="150" alt="">
                    </div>
                    <div class="form-group ">
                ...
                <div class="col-12 mt-5">
                    ...
                    <div class="form-group mt-5">
                       <textarea class="ckeditor" name="data_post[content]" id="editor1" cols="30" rows="10"></textarea>
                    </div>
                </div> 
            </div>
